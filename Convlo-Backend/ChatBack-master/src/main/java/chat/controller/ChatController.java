...
public class ChatController {
	...
	@GetMapping("/{roomId}/roomProfile") //取得房間資訊
	public ResponseEntity<ApiResponse<ChatroomDto>> getChatroom(@PathVariable String roomId) {
		return ResponseEntity.ok(ApiResponse.success("查詢成功", chatService.getChatroom(roomId)));
	}
